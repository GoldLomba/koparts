...
type BrandFilter = 'all' | 'Daewoo Matiz' | 'Chevrolet Spark';
...
export function Catalog() {
  ...
  const filteredEngines = engines.filter(engine => {
    ...
    return brandMatch && engine.condition === 'new';
  });
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Широкий ассортимент новых двигателей для Daewoo Matiz и Chevrolet Spark. 
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-10">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {(['all', 'Daewoo Matiz', 'Chevrolet Spark'] as BrandFilter[]).map(brand => (
              <button
                key={brand}

...
const features = [
  {
    title: 'Контрактные двигатели',
    text: 'Б/у моторы из Кореи и Японии в идеальном состоянии. Пробег от 40 до 100 тыс. км.',
  },
  {
    title: 'Проверка перед отправкой',
    text: 'Замер компрессии, проверка геометрии блока, тест на стенде. Видеоотчёт на запрос.',
  },
  {
    title: 'Гарантия 6 месяцев',
    text: 'Заменим или вернём деньги, если двигатель не запустится или есть скрытый дефект.',
  },
  {

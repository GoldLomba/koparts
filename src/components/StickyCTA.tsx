...
export default function StickyCTA() {
  ...
  return (
    <div
      className={`md:hidden fixed inset-x-0 bottom-0 z-40 bg-white border-t border-border shadow-[0_-4px_20px_rgba(0,0,0,0.08)] transition-transform duration-300 ${

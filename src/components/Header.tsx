...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="md:hidden sticky top-0 z-50 bg-primary px-4 py-1.5 flex items-center justify-center gap-2">
      ...
      <header className="bg-white border-b border-border md:sticky md:top-0 z-50">

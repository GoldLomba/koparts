...
export type Engine = {
  ...
  /** Customer reviews — each with photo, author, rating and text */
  reviews?: {
    src: string;
    author: string;
    location?: string;
  ...
  /** FAQ items shown on the engine detail page */
  faq?: { q: string; a: string }[];
  /** Units currently in stock — used for scarcity signals */
  stockCount?: number;
};
...
export const engines: Engine[] = [
  {
    ...
    description:
      'Надёжный и проверенный мотор для Daewoo Matiz и Chevrolet Spark. Доступен в двух исполнениях — под катушку зажигания и под трамблёр. Только новые двигатели в заводской упаковке.',
    ...
    faq: [
      {
        q: 'Подойдёт ли этот двигатель к моей модели?',
        a: 'F8CV устанавливался на Daewoo Matiz I/II (1998–2015), Chevrolet Spark (2000–2009) и аналогичные модели. Рекомендуем сверять VIN или маркировку двигателя (A08S3/F8CV).',
      },
      {
        q: 'Какая гарантия?',
        a: 'Мы даём гарантию 1 год с заменой комплектующих при обнаружении заводских неисправностей.',
      },
      {
        q: 'Как осуществляется доставка?',
        a: 'Отправляем транспортными компаниями (Деловые Линии, ПЭК, СДЭК) по всей России. Срок — 1–5 дней. Отгрузка двигателя в тот же или на следующий день после оплаты. Стоимость доставки включена в цену.',
      },
      {
        q: 'Можно ли заказать установку?',
        a: 'Установка возможна у наших сервисов-партнёров. Стоимость — 25 000 ₽ «под ключ». В стоимость включены масло и антифриз.',
      },
    ],
    reviews: [
      {
        src: 'reviews/f8cv-1.jpg',
        author: 'Алексей',
        location: 'Москва',
        rating: 5,
        date: 'март 2026',
        text:
          'Старый F8CV на Матизе уже дымил и троил после 280 тысяч пробега — искал контракт, но в итоге решил брать новый. Менеджер по Telegram быстро уточнил исполнение (под катушку), прислал фото и видео мотора со склада. Цена честная.',
      },
      {
        src: 'reviews/f8cv-2.jpg',
        author: 'Иван',
        location: 'Краснодар',
        rating: 5,
        date: 'апрель 2026',
        text:
          'Отгрузили в день оплаты. Транспортной (Деловые Линии) дошёл за 4 дня в Краснодар. Упаковка серьёзная — металлический ящик на паллете, внутри стяжки. Никаких вмятин, потерь — забирал в идеальном состоянии.',
      },
      {
        src: 'reviews/f8cv-3.jpg',
        author: 'Дмитрий',
        location: 'Казань',
        rating: 5,
        date: 'апрель 2026',
        text:
          'Внутри металлической обрешётки — заводская деревянная коробка с пенопластом и плёнкой. Двигатель закреплён жёстко, не болтается. Видно, что упаковано на заводе, а не «перебрано после кого‑то». Спасибо за честный товар.',
      },
      {
        src: 'reviews/f8cv-4.jpg',
        author: 'Сергей',
        location: 'Санкт-Петербург',
        rating: 5,
        date: 'апрель 2026',
        text:
          'Распаковал — мотор новый, без следов установки. Маркировка F8CV MATIZ‑3 D, шильдик M‑TEC на месте, номер совпал с тем, что прислал менеджер. Установили на Матиз — завёлся с первого раза, работает ровно, расход в норме. Рекомендую!',
      },
    ],
    stockCount: 3,
  },
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: 'февраль 2026',
        text: 'Заказывал G4EE на Hyundai Getz 2006 года. Менеджер подтвердил совместимость по VIN, прислал фото мотора на складе. Доставка ПЭК заняла 5 дней — упакован хорошо. Мотор встал как родной, работает без нареканий уже 2 месяца.',
      },
      {
        src: '',
        author: 'Максим',
        ...
        rating: 5,
        date: 'март 2026',
        text: 'Брал G4EE для Hyundai Accent MC. Цена по рынку нормальная, главное — новый, а не контракт неизвестного происхождения. Документы на двигатель выдали, что важно для постановки на учёт. Рекомендую KO PARTS.',
      },
      {
        src: '',
        author: 'Руслан',
        ...
        rating: 5,
        date: 'апрель 2026',
        text: 'Искал новый G4EE — в местных магазинах либо б/у, либо очень дорого. Здесь нашёл по адекватной цене. Связался в Telegram, ответили быстро. Отгрузили через день, получил через Деловые Линии. Двигатель в заводской упаковке, всё отлично.',
      },
      {
        src: '',
        author: 'Виктор',
        ...
        rating: 5,
        date: 'апрель 2026',
        text: 'Устанавливали G4EE на KIA Rio II 2008 г. Менеджер сразу сказал, что мотор точно подойдёт. Запустили без каких-либо проблем. Особенно понравилось, что дали все документы для ГИБДД — без них замену двигателя не оформить легально.',
      },
    ],
    stockCount: 4,
  },
